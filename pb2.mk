DESCRIPTOR_SRC=src/main/include
PROTO_SRC=src/main/protobuf
PY_SRC=protobuf_rpc/
#JAVA_SRC=src/main/java
#NODE_SRC=src/main/node
...
$(PY_SRC)/%_pb2.py: $(PROTO_SRC)/%.proto
	mkdir -p $(PY_SRC)
	protoc --proto_path=/usr/include/ --proto_path=env/lib/python2.7/site-packages/ --python_out=$(PY_SRC) -I$(PROTO_SRC) -I$(DESCRIPTOR_SRC)  $<
